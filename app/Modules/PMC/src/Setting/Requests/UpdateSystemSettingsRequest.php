...
namespace App\Modules\PMC\Setting\Requests;

use App\Common\Requests\BaseFormRequest;
use Illuminate\Contracts\Validation\Validator;
use Illuminate\Support\Facades\Validator as ValidatorFacade;

class UpdateSystemSettingsRequest extends BaseFormRequest
{
    /**
    ...
    private const GROUP_KEY_RULES = [
        'og_ticket' => [
            'sla_quote_minutes' => ['required', 'integer', 'min:1'],
            'sla_completion_minutes' => ['required', 'integer', 'min:1'],
        ],
        'bank_account' => [
