...
class ExtCreateShiftRequest extends BaseFormRequest
{
    /**
    ...
    {
        $apiProjectId = (int) $this->attributes->get('api_project_id');

        return [
            'code' => [
                'required', 'string', 'max:50',
                Rule::unique('shifts', 'code')->where(fn ($q) => $q->where('project_id', $apiProjectId)),
            ],
