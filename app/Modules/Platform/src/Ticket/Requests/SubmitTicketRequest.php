...
class SubmitTicketRequest extends BaseFormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'requester_email' => ['nullable', 'email:rfc', 'max:255'],
            'subject' => ['required', 'string', 'max:500'],
            'description' => ['nullable', 'string'],
            'address' => ['nullable', 'string', 'max:500'],
            'latitude' => ['nullable', 'numeric', 'between:-90,90'],
            'longitude' => ['nullable', 'numeric', 'between:-180,180'],
            'channel' => ['nullable', 'string', Rule::in(TicketChannel::values())],
            'project_id' => ['nullable', 'integer'],
            'claimed_by_org_id' => ['nullable', 'string'],
    ...
    {
        return [
            'requester_name.required' => 'Tên người gửi là bắt buộc.',
            'requester_name.max' => 'Tên người gửi không được vượt quá 255 ký tự.',
            'requester_phone.required' => 'Số điện thoại là bắt buộc.',
            'requester_phone.max' => 'Số điện thoại không được vượt quá 20 ký tự.',
            'requester_email.email' => 'Email không hợp lệ.',
            'requester_email.max' => 'Email không được vượt quá 255 ký tự.',
            ...
            'claimed_by_org_id.string' => 'Tổ chức không hợp lệ.',
